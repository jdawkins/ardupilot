...
void GCS_MAVLINK::handleMessage(mavlink_message_t* msg)
{
	...
	case MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST: 	//MAV ID: 56
	{
		
		break;
	}
	case MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_SPEED_THRUST: //MAV ID: 57
	{
	...
	{
		handle_manual_setpoint(msg,&attitude_control,&pos_control);
		break;
	}
